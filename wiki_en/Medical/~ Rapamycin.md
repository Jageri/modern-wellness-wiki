...
- Dog Aging Project RAPA trial: 1,000+ elderly dogs enrolled; results expected 2026–2027
- Side effects (with continuous use): Immunosuppression, oral ulcers, hyperlipidemia, hyperglycemia, delayed wound healing
- Cyclical dosing may reduce side effects, but the optimal regimen is not yet established

## Do
1. **Not recommended for self-use currently**—await RAPA trial and more human data
2. If interested in the mTOR pathway: Exercise (especially strength training) is the safest way to modulate mTOR
3. Intermittent fasting can also modulate mTOR activity
4. Follow Dog Aging Project results
...
- [2] Kaeberlein M et al. Rapamycin and ageing: when, for how long, and how much? J Genet Genomics. 2014;41:459-463. https://pubmed.ncbi.nlm.nih.gov/25269671/
